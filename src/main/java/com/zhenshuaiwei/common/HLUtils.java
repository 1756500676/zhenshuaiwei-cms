...
public class HLUtils {
	...
	private static AggregatedPage aggregatedPage;
	...
	public void setElasticsearchTemplate(ElasticsearchTemplate elasticsearchTemplate) {
		HLUtils.elasticsearchTemplate = elasticsearchTemplate;
	}
	...
	// 查询操作
	public static <T> AggregatedPage<T> selectObjects( Class<T> clazz, Integer page,
	...
	// 查询操作2
	public static <T> HLUtils selectPageObjects( Class<T> clazz, Integer page,
			Integer rows, String fieldNames[],String sortField, String value) {
		HLUtils hlUtils = new HLUtils();
		hlUtils.setPageNum(page);
		hlUtils.setPageSize(rows);
		...
		hlUtils.setTotal((int)pageInfo.getTotalElements());
		hlUtils.aggregatedPage=pageInfo;
		return hlUtils;
	}
	
	
	
	public AggregatedPage getAggregatedPage() {
		return this.aggregatedPage;
	}
	
	public <T> PageInfo<T> getPageInfo(){
		PageInfo<T> info = new PageInfo<T>(this.aggregatedPage.getContent());
		info.setPageNum(this.pageNum);
		info.setPageSize(this.pageSize);
		int pages = this.total / this.pageSize + ((this.total % this.pageSize == 0) ? 0 : 1 );
